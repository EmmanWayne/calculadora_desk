...
public class ventana_calculadora_2 extends JFrame {
	...
	public ventana_calculadora_2() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(ventana_calculadora_2.class.getResource("/recursos_otros/calculadora.png")));
		setResizable(false);
		...
		// Recursos tema claro
		final ImageIcon n1 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/1.png"));
		final ImageIcon n2 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/2.png"));
		final ImageIcon n3 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/3.png"));
		final ImageIcon n4 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/4.png"));
		final ImageIcon n5 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/5.png"));
		final ImageIcon n6 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/6.png"));
		final ImageIcon n7 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/7.png"));
		final ImageIcon n8 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/8.png"));
		final ImageIcon n9 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/9.png"));
		final ImageIcon n0 = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/0.png"));
		final ImageIcon borrar = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/borrar.png"));
		final ImageIcon eliminar = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/eliminar.png"));
		final ImageIcon suma = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/sumar.png"));
		final ImageIcon resta = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/restar.png"));
		final ImageIcon multiplicacion = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/multiplicar.png"));
		final ImageIcon division = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/dividir.png"));
		final ImageIcon punto = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/punto.png"));
		final ImageIcon tema = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/tema.png"));
		final ImageIcon igual = new ImageIcon(getClass().getResource("/recursos_tema_oscuro/igual.png"));
	...
	public static void main(String[] args) {
		...
		ventana_calculadora_2 calculadora1 = new ventana_calculadora_2();
